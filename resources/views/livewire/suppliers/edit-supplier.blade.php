<div class="relative inline-block text-center cursor-pointer group">
    ...
    <x-dialog-modal wire:model="open_edit">
        <x-slot name="title">
            <h2 class="mt-3 text-2xl text-center">Actualizar Proveedor</h2>
        </x-slot>
                    ...
                    <div class="relative my-4">
                        <label
                            ...
                            <div class="text-center">
                                <span class="font-normal text-gray-600">Cambiar imagen de proveedor
                                    (opcional)</span>
                            </div>
                            ...
                            <div class="absolute top-0 h-48 w-72">
                                @if ($image)
                                    <img class="object-cover w-full h-full rounded-lg"
                                        src="{{ $image->temporaryUrl() }}" class="mb-4" alt="Foto del proveedor">
                                @else
                                    <img class="object-cover w-full h-full rounded-lg"
                                        src="{{ asset('storage/' . $supplier->image) }}" class="mb-4"
