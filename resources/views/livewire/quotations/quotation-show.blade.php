<div class="relative inline-block text-center cursor-pointer group">
    <a href="#" wire:click="$set('open_quotation', true)">
    ...
    @if ($open_quotation)
    <div wire:model="open_quotation">
        <div class="fixed inset-0 z-50 flex items-center justify-center" wire:click="$set('open_quotation', false)">
            ...
            <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white border border-gray-500 rounded-xl modal-container md:max-w-md">
                ...
                <div class="md:px-5 pb-5">
                    ...
                    <div>
                        ...
                        <div class="text-lg text-start">
                            <div class="mb-3">
                                <h1 class="ml-2 text-sm">Fecha de Cotización:</h1>
                                <p class="p-2 bg-gray-200 rounded-md">{{ $quotation->quotation_date }}</p>
                            </div>
                            <div class="mb-3">
                                <h1 class="ml-2 text-sm">Período de Validez:</h1>
                                <p class="p-2 bg-gray-200 rounded-md">{{ $quotation->validity_period }}</p>
                            </div>
                            <div class="mb-3">
                ...
                <div class="mx-auto">
                    <x-secondary-button wire:click="$set('open_quotation', false)" class="text-gray-500 bg-gray-200 border border-gray-500 shadow-lg hover:shadow-gray-400 hover:bg-gray-500 hover:text-white">
                        Salir
                    </x-secondary-button>
                </div>
            </div>
