...
<div class="grid grid-cols-1 gap-6 p-6 bg-gray-200 bg-opacity-25 dark:bg-gray-800 md:grid-cols-2 lg:gap-8 lg:p-8">
    ...
    <div>
        ...
        <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
            Laravel Jetstream está construido con Tailwind, un increíble framework de CSS basado en utilidades que no se
            interpone en tu camino. Te sorprenderá lo fácil que es construir y mantener diseños frescos y modernos con
            esta maravillosa herramienta a tu disposición.
        </p>
    </div>
