<x-guest-layout>
    <div>
        ...
        <div class="container mx-auto p-4">
            ...
            <div class="prose">
                <h2>¡Bienvenido a nuestra sección de Ayuda y Soporte!</h2>
                <p>Estamos aquí para asistirte en el uso de Quick Quote GSV Ingeniería. Si encuentras algún problema o necesitas orientación, revisa las secciones a continuación o contáctanos directamente.</p>
            </div>
            ...
            <section class="mb-8">
                ...
                <p>Consulta nuestra lista de preguntas frecuentes para obtener respuestas rápidas a las dudas más comunes. Aquí encontrarás información sobre problemas comunes, soluciones rápidas y consejos útiles.</p>
            </section>

            <!-- Sección 4: Tutoriales -->
            <section class="mb-8">
                <h2>Tutoriales</h2>
                <p>Explora nuestra serie de tutoriales paso a paso para aprender a utilizar todas las funciones y características de Quick Quote GSV Ingeniería. Desde funciones básicas hasta avanzadas, estos tutoriales te guiarán en cada paso.</p>
            </section>
